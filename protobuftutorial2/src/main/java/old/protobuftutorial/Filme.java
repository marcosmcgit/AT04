...
import old.protobuftutorial.FilmeProto.MFilme;
import old.protobuftutorial.FilmeProto.MListaFilmes;
...
public class Filme {
	...
	private static MFilme constroiMfilme(Filme filme) {
		old.protobuftutorial.FilmeProto.MFilme.Builder mFilmeBuilder = old.protobuftutorial.FilmeProto.MFilme.newBuilder();
	...
	private static MListaFilmes constroiMListaFilmes(List<Filme> listFilmes) {
		...
		old.protobuftutorial.FilmeProto.MListaFilmes.Builder mListaFilmesBuilder = old.protobuftutorial.FilmeProto.MListaFilmes
				.newBuilder();
